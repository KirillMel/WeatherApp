...
class ServerTemperatureService {
    let alamofire = AlamofireWrapper.shared
    var parser = ParserRaw()
    var networkProtocol: NetworkProtocol?
    var route: String = "https://api.openweathermap.org/data/2.5/weather"
    let key = "9c00cdea5b57e45ab0d21383d6247b98"
